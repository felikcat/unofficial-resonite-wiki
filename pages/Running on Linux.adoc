...
Go to 'Patches' then add the Bigscreen Beyond patch using 'Add remote patch', then put in: `https://raw.githubusercontent.com/felikcat/unofficial-resonite-wiki/refs/heads/main/files/bigscreenBeyond_6_11.patch`. +
After that's done, build the kernel.

Once it's done building and installed, reboot into the new kernel and enjoy the Bigscreen Beyond!
